...
function useCountState() {
  ...
  if (typeof countState === undefined) {
    throw new Error('useCountState must be used with CountStateContext');
  }
  return countState;
}
...
function useCountUpdater() {
  ...
  if (typeof setCount === undefined) {
    throw new Error('useCountUpdater must be used with CountUpdateContext');
  }
...
export { CountProvider, useCountUpdater, useCountState };
